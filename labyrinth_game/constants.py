...
ROOMS = {
    ...
    'cellar': {
        ...
        'exits': {'east': 'kitchen'},
        'items': ['human meat'],
        'puzzle': ('При попытке осмотреть останки, холодные веки поднимаются и на вас смотрят, не моргая, два мутных глаза... "Без окон без дверей. Полна горница людей?" - вопрошает тело','огурец')
    }
